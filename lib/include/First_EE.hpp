...
struct inputFile {
	...
	//int nt = 600; // Number of time steps
	//double dt = .1; // Time step in seconds
	//int epsi = 1; // 1 over epsilon naught(F / m) Epsilon normalized to 1
	//int ng = 32; // Number of spatial grid points - only change the power of 2
	...
	//std::array<int, 2> N = { 1280, 1280 }; // Number of simulation particles
